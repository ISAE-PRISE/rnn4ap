...
dataframe = pd.read_csv('../datasets/imu/D5.csv',dtype = np.float32)
...
file = open("D5_filtered_low_pass.csv", mode="w")
...
file = open("D5_scaled_pytorch.csv", mode="w")
...
file = open("D5_results_lstm_gru.csv", mode="w")
...
file = open("D5_loss_report.csv", mode="w")
file.write("epoch_id,")
